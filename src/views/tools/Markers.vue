		...
		<div id="markerGenerator">
			...
			<div id="markerGeneratorMap">
				...
				<div id="outputArea">
					...
					<button class="button green" @click="showOutputModal = true">
						<i class="far fa-code"></i>
						<span>Show CSS output</span>
					</button>
...
.myicon:before{
  animation: marker-{{marker.animation}}{{marker.iconShape == 'diamond' ? '-rotate' : ''}} 2s ease-in-out 0s infinite normal none;
  transform-origin: 50% 50%;
}
.myicon:after{
...
@keyframes marker-bounce-rotate {
  ...
  10% {
    transform: translateY(0) rotate(-45deg);
		...
		<!-- Instructions -->
		<div class="max-width margin-auto mtop-xl mbottom-lg">
